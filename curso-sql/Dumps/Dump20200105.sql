...
INSERT INTO `pma__userconfig` VALUES ('root','2020-01-01 00:09:48','{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
...
-- Dump completed on 2020-01-05 15:51:49
CREATE DATABASE  IF NOT EXISTS `relatorio1` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `relatorio1`;
-- MariaDB dump 10.17  Distrib 10.4.11-MariaDB, for Win64 (AMD64)
--
-- Host: 127.0.0.1    Database: relatorio1
-- ------------------------------------------------------
-- Server version	10.4.11-MariaDB
...
CREATE TABLE `pessoas` (
  ...
  `prof` varchar(20) NOT NULL DEFAULT 'bombeiro'
...
INSERT INTO `pessoas` VALUES ('Thiago','2004-06-03',53.20,'M','Brasil',''),('Goodolfredo','2000-08-06',70.20,'M','Espanha',''),('Isabela','1998-12-11',55.50,'F','Australia','');
...
INSERT INTO `curso` VALUES (1,'HTML4','Curso de HTML',20,40,2020),(2,'CSS','Curso de CSS',30,50,2000),(3,'MySQL','Curso de Java',41,65,2017),(4,'PHG','Curso de JavaScript',89,54,2010),(5,'Javar','Curso de Banco de Dados',10,45,2010),(6,'Python','Curso de Python',10,78,2015),(7,'JavaScript','Curso de PHP',8,85,2013),(8,'Java POO','Curso de java orientado a objetos',44,78,2018),(9,'PHP POO','Curso de PHP orientado a objetos',45,77,2018),(10,'C#','Curso de C#',80,6,2018);
/*!40000 ALTER TABLE `curso` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `peaples`
--

DROP TABLE IF EXISTS `peaples`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `peaples`
--

LOCK TABLES `peaples` WRITE;
/*!40000 ALTER TABLE `peaples` DISABLE KEYS */;
/*!40000 ALTER TABLE `peaples` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2020-01-05 15:51:50
CREATE DATABASE  IF NOT EXISTS `relatorio2` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `relatorio2`;
-- MariaDB dump 10.17  Distrib 10.4.11-MariaDB, for Win64 (AMD64)
--
-- Host: 127.0.0.1    Database: relatorio2
-- ------------------------------------------------------
-- Server version	10.4.11-MariaDB
...
INSERT INTO `mercadorias` VALUES (1,'Leguma',19.00,'2020-01-15','Atacadao Maringá'),(2,'Manga',15.00,'2020-01-20','Atacadao Maringá'),(3,'morango',50.00,'2020-01-08','Atacadao Maringá'),(4,'Repolho',41.00,'2020-01-13','Atacadao Maringá'),(6,'Manga',15.90,'2020-01-20','Atacadao Maringá'),(7,'morango',50.00,'2020-01-08','Atacadao Maringá'),(8,'Repolho',41.20,'2020-01-13','Atacadao Maringá'),(9,'Tomate',19.90,'2020-01-11','Atacadao Maringá'),(10,'Manga',15.90,'2020-01-02','Atacadao Maringá'),(11,'morango',50.00,'2020-01-08','Atacadao Maringá'),(12,'Repolho',41.20,'2020-01-12','Atacadao Maringá'),(13,'Fruta',19.90,'2020-01-11','Atacadao Maringá'),(14,'Fruta',15.90,'2020-01-02','Atacadao Maringá'),(15,'Fruta',50.00,'2020-01-08','Atacadao Maringá'),(16,'Leguma',41.20,'2020-01-12','Atacadao Maringá');
